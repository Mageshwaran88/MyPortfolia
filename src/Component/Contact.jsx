        ...
        >
          <Card.Body>
            ...
            <Card.Text style={{ color: "#555", fontSize: "1rem", lineHeight: "2.2" }}>
              <strong>Address:</strong> Srivasa nagar,Madipakkam, Chennai, Tamil Nadu
              <br />
              <strong>Phone:</strong> +91 9943366427
              <br />
              <strong>Email:</strong> mageshwaran882002@gmail.com
            </Card.Text>
            <div className="d-flex justify-content-start mt-4">
             <a href="https://www.linkedin.com/in/mageshwaran88" target='blank' className='me-3' style={{ color: "#0077b5" }}>
                <i className="bi bi-linkedin" style={{ fontSize: "1.2rem", transition: "0.3s", transform: "scale(1)" }}></i>
              </a>
              <a href="https://www.instagram.com/magesh__official__/" target='blank' className='me-3' style={{ color: "#c32aa3" }}>
                <i className="bi bi-instagram" style={{ fontSize: "1.2rem", transition: "0.3s", transform: "scale(1)" }}></i>
              </a>
              <a href="https://web.whatsapp.com/" target='blank' className='me-3' style={{ color: "#25d366" }}>
                <i className="bi bi-whatsapp" style={{ fontSize: "1.2rem", transition: "0.3s", transform: "scale(1)" }}></i>
              </a>
              <a href="https://github.com/Mageshwaran88/" target='blank' style={{ color: "#333" }}>
