      ...
      <Col sm={12} md={12} xs={12} lg={6} className="my-5">
        ...
        >
          <Card.Body className="p-0 mt-1">
            <Card.Title>
              <h3 className="mt-1 text-info">Hi, I'm Mageshwaran</h3>
            </Card.Title>
            <Card.Text className="text-muted">
              <ul className="list-unstyled">
                <li className="mt-3 custom-list-item">
                  <i className="bi bi-code-slash text-primary me-2"></i>
                  I'm a passionate front-end developer with experience in creating responsive and dynamic web applications. I specialize in Next.js and have a strong foundation in HTML, CSS, JavaScript, React.js.
                </li>
                <li className="mt-3 custom-list-item">
